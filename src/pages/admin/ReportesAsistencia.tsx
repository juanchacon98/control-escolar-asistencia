...
const ReportesAsistencia = () => {
  ...
  const { data: records, isLoading } = useQuery({
    queryKey: ['attendance-records', selectedYear, selectedSection, searchName, dateFrom, dateTo],
    queryFn: async () => {
      if (!selectedYear || !selectedSection || !dateFrom || !dateTo) return [];
      ...
      let query = supabase
        ...
        `)
        .eq('students.sections.year_id', selectedYear)
        .eq('students.sections.letter', selectedSection)
    ...
    enabled: !!selectedYear && !!selectedSection && !!dateFrom && !!dateTo,
  });
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Consulta las inasistencias por año, sección, estudiante y rango de fechas
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <SelectContent>
                    {sections?.map((section) => (
                      <SelectItem key={section.id} value={section.letter}>
                        Sección {section.letter}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2 flex items-end">
                <Button 
                  ...
                  className="w-full"
                  disabled={!selectedYear || !selectedSection || !dateFrom || !dateTo}
                >
